...
export default function NotFound() {
  return (
    <>
      <Header />
      <section className="w-full overflow-hidden bg-[url(/images/img-bg-404.svg)] bg-cover bg-center pt-28 pb-20">
        <div className="relative flex h-full w-full flex-col items-center justify-end">
          ...
          <div className="to-brand-dark-green absolute bottom-0 left-0 z-30 flex h-fit w-full flex-col items-center justify-center bg-gradient-to-b from-transparent to-80% pt-40 pb-2">
            ...
            <p className="mb-10 text-center text-lg leading-normal text-white md:mb-14 md:text-xl">
              Desculpe, mas a página que você tentou acessar pode ter sido
              movida,
