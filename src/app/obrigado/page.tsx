...
export default function ObrigadoPage() {
  return (
    <>
      <section className="h-[500px] w-full overflow-hidden bg-[url(/images/img-bg-obrigado.svg)] bg-cover bg-center pt-20 md:h-[680px]">
        <div className="relative flex h-full w-full flex-col justify-end">
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 md:-bottom-16">
            <Image
              ...
              width={347}
              height={454}
              className="relative z-20 object-contain md:h-full md:w-full"
            />
            <svg
          ...
          <div className="to-brand-dark-green relative z-30 flex h-fit w-full flex-col items-center justify-center bg-gradient-to-b from-transparent py-10">
            ...
            <p className="text-center text-lg leading-normal text-white md:text-xl">
