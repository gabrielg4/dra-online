    ...
    <section className="overflow-hidden bg-[url('/images/img-bg_hero.webp')] bg-cover bg-center pt-32 pb-10 md:pb-20">
      <div className="mx-auto flex w-full max-w-[1280px] flex-col items-center justify-center px-4">
        ...
        <div className="relative mb-8 sm:mb-12">
          <div className="image-detail from-brand-dark-green to-brand-dark-green/0 absolute -top-1.5 -right-[48px] flex w-[201px] justify-end rounded-full bg-gradient-to-l p-1 max-sm:-right-4 sm:-right-5">
            <Image
              className=""
        ...
        <div className="cta-button">
          <CtaButton title="Fale com nosso time" url="/contato" />
        </div>
        <HeroAnimation />
        <HeroAnimationMobile />
      </div>
