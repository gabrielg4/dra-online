  ...
  return (
    <section className="s-problems overflow-hidden py-16 max-sm:py-10">
      <div className="container flex items-center justify-between gap-4 max-lg:flex-col max-lg:gap-10">
        ...
        <div className="right-container w-full max-w-2xl">
          <Swiper
            ...
            className="[&_.swiper-slide:not(.swiper-slide-active)]:bg-brand-dark-green/70 [&_.swiper-slide.swiper-slide-active]:bg-brand-dark-green/70 [&_.swiper-slide:not(.swiper-slide-active)]:blur-[2px]"
          >
