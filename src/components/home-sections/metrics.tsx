  ...
  return (
    ...
    >
      <div className="container flex flex-col items-center gap-8 md:gap-10 lg:flex-row lg:gap-14">
        <div className="flex w-full flex-row items-end gap-8 lg:max-w-[373px] lg:flex-col lg:items-start lg:gap-0">
          <div>
            ...
            <h2 className="title-section-metrics mb-0 text-center text-sm leading-[120%] font-medium text-white sm:text-[32px] md:text-start lg:mb-4 lg:text-[40px]">
