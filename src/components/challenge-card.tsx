...
export const ChallengeCard = ({
  ...
  return (
    <div
      {...props}
      className={cn(
        "challenge-card w-full max-w-[312px] rounded-2xl border border-white/20 bg-white/20 p-4 backdrop-blur-2xl max-sm:max-w-[240px] max-sm:p-2 md:min-h-[350px] md:max-w-[360px] md:p-6",
        props.className,
      )}
    >
      {videoUrl && (
