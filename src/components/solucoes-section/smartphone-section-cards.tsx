      ...
      <div className="container !px-0">
        <div className="image-wrapper relative flex items-end justify-center gap-4 bg-[url('/images/bg-security.webp')] bg-cover bg-center pt-20 lg:pt-20">
          ...
          <Image
            src={leftPhoneImg}
            alt=""
            className={`mobile-fone-left h-full w-[110px] object-contain ${cardsBigger ? "sm:w-[340px]" : "sm:w-[220px]"}`}
            width={256}
            height={510}
            quality={100}
          />
          ...
          <Image
            src={rightPhoneImg}
            alt=""
            className={`mobile-fone-right h-full w-[110px] object-contain ${cardsBigger ? "sm:w-[340px]" : "sm:w-[220px]"}`}
            width={256}
            height={510}
            quality={100}
          />
