...
export const Hero = ({ description, title }: HeroSolutionProps) => {
  useGSAP(() => {
  ...
  return (
    <section className="solution-hero relative h-[500px] bg-[url(/images/img-bg-hero-solucao-1.webp)] bg-cover bg-center bg-no-repeat md:h-[580px]">
