...
export const TestimonialsSection = ({
  ...
  return (
    <section className="testimonials-section relative bg-[url(/images/img-bg-testimonials.svg)] bg-cover bg-center bg-no-repeat max-sm:overflow-hidden max-sm:py-10 lg:pt-20 lg:pb-20">
